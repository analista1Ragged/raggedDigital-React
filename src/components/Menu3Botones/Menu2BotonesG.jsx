...
const Menu2BotonesG = ({ onDownload, iconGroup = <MoreOutlined style={{ color: 'white' }} />, iconButton = <FaTruckFast  />, iconButton2 = <FaStripeS />, title = "Preparar Guias", buttonStyle = { backgroundColor: '#0E79FD', color: 'white' }, groupStyle = { position: 'fixed', bottom: 20, right: 20 } }) => (
  <>
    <div>
